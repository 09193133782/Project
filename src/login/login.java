...
public class login extends javax.swing.JFrame {
    ...
    public static boolean loginAccount(String username, String password) {
        try (Connection cn = new config().getConnection()) {
            ...
            PreparedStatement checkStmt = cn.prepareStatement("SELECT COUNT(*) FROM seats WHERE user = ? AND pass = ? AND status = 'Active'");
    ...
    public static void showTable(DefaultTableModel table) {
        ...
        try {
            ...
            ResultSet rs = new config().getData("SELECT * FROM seats");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Movie Seat Reservation");
